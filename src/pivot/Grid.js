...
* The component is compatible with Extjs 4.1.x and 4.2.x.
*
*/
...
#Example usage:#
    ...
    */
    preInitialize: function(){
        ...
        if (extjsVersion.match('4.1')) {
            ftype = 'pivotview41';
        }else if (extjsVersion.isGreaterThanOrEqual && extjsVersion.isGreaterThanOrEqual(4.2)) {
            ftype = 'pivotview42';
        }
        if(ftype){
            feature.ftype = ftype;
        ...
        */
        ...
        // create a dummy store until we receive one from the matrix
        me.store = me.getDummyStore();
    ...
    */
    postInitialize: function(){
        ...
        me.matrixRelayedListeners = me.relayEvents(me.matrix, ['start', 'progress', 'done', 'modelbuilt', 'columnsbuilt', 'recordbuilt', 'storebuilt'], 'pivot');
    },
    ...
    */
    onMatrixClearData: function(){
        ...
        // we have to unbind the previous pivot store otherwise the grid view will throw errors.
        me.reconfigure(me.getDummyStore());
    },
    ...
    */
    onMatrixDataReady: function(){
        ...
        me.reconfigure(me.matrix.pivotStore, cols);
    ...
    */
    getStore: function(){
        ...
        return (matrix instanceof Mz.aggregate.matrix.Local) ? matrix.store : me.originalStore;
    },
    ...
    */
    onHeaderClick: function(ct, column, e){
        ...
        if(column.leftAxis || column.topAxis){
